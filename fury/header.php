	...
	<header>
		...
		<div class="nav-bar">
			<div class="container">
				<h1 class="logo">
					<a href="#">
							<strong>KNIHKUPECTVO</strong> FURY<i class="fa fa-fire"></i>
					</a>
				</h1>
				...
				<nav class="group">
					<ul class="menu navigation">
						...
						<li><a href="onas.php"><i class="fa fa-bolt fa-2x"></i> O nás</a></li>
						<li><a href="kontakt.php"><i class="fa fa-trophy fa-2x"></i> Kontakt</a></li>
					</ul>
				</nav>
			</div>
		</div>
